# Documentación MaldoxFilm

> Base de conocimiento técnico del proyecto. Léelos en orden si estás aprendiendo el sistema.
...
| [SELECCION_MEJOR_STREAM.md](SELECCION_MEJOR_STREAM.md) | Cómo MaldoxFilm elige la mejor versión: resolución, codecs de video y audio |
| [FLUJO_RD_TORRENTIO.md](FLUJO_RD_TORRENTIO.md) | Flujo técnico RD + Torrentio paso a paso + errores conocidos |
| [X265_EXPLICADO.md](X265_EXPLICADO.md) | Qué es x265, por qué Chrome no lo reproduce y cómo RD lo soluciona |
| [ENDPOINTS.md](ENDPOINTS.md) | Todas las APIs y endpoints usados en la app |
| [ANALISIS_STREAMIX.md](ANALISIS_STREAMIX.md) | Análisis del APK original Streamix del que partió el proyecto |
